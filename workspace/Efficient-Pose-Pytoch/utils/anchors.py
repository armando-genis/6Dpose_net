...
def anchor_targets_bbox(
    ...
    transformation_batch  = np.zeros((anchors.shape[0], num_rotation_parameters + num_translation_parameters + 1), dtype = np.float32)
    ...
    if annotations['bboxes'].shape[0]:
        ...
        transformation_batch[ignore_indices, -1]   = -1
        transformation_batch[positive_indices, -1] = 1
        ...
        transformation_batch[ :, :-1] = annotations['transformation_targets'][argmax_overlaps_inds, :]
        ...
        if image.shape:
            ...
            transformation_batch[indices, -1] = -1
